...
module ext_io_2 (
  ...
  button_conditioner_6 start_cond (
    .clk(clk),
    .in(M_start_cond_in),
  ...
  button_conditioner_6 reset_cond (
    .clk(clk),
    .in(M_reset_cond_in),
  ...
  button_conditioner_6 down_cond (
    .clk(clk),
    .in(M_down_cond_in),
    .out(M_down_cond_out)
  );
  ...
  button_conditioner_6 left_cond (
    .clk(clk),
    .in(M_left_cond_in),
    .out(M_left_cond_out)
  );
  ...
  button_conditioner_6 right_cond (
    .clk(clk),
    .in(M_right_cond_in),
  ...
  always @* begin
    ...
    M_reset_edge_in = M_reset_cond_out;
